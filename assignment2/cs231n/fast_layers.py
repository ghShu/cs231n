...
def conv_forward_strides(x, w, b, conv_param):
  ...
  # Pad the input
  p = pad
  x_padded = np.pad(x, ((0, 0), (0, 0), (p, p), (p, p)), mode='constant') # only pad for H and W, both before and after with p '0'
...
def max_pool_backward_reshape(dout, cache):
  ...
  valid subgradient. You can make this happen by uncommenting the line belobw;
